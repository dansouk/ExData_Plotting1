...
# Create plot 4
png(filename = paste(wd, '/plot4.png', sep = ''), width=480, height=480)
par(mfrow = c(2, 2)) 
...
#Bottom left
plot(dataFeb$DateTime, dataFeb$Voltage, type = 'l', xlab = 'datetime', ylab = 'Voltage')
...
# Bottom right
plot(dataFeb$DateTime, dataFeb$Global_reactive_power, type = 'l', xlab = 'datetime', ylab = 'Global_reactive_power')
